...
# arr1 = []
# for i in range(n):
#  arr1.append(int(input('Введите количество ягод на кусте: ')))
# arr2=list()
# for i in range (len(arr1)-1):
#  arr2.append(arr1[i-1]+arr1[i]+arr1[i+1])
# arr2.append (arr1[-2]+arr1[-1]+arr1[0])
# print(max(arr2))
...
line = (input('Введите символы строки через пробел: ')) 
words = []      
for i in line:
    words.append(i) 
print(len(words))
